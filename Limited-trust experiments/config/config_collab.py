...
# Each cluster: 6 near-edge, 2 far-edge, 1 cloud
...
# Machines per Node
MACHINES_EDGE = (1, 2)    # near-edge
MACHINES_FOG = (2, 4)     # far-edge
MACHINES_CLOUD = (5, 5)

# --- Machine Performance Coefficients ---
SPEED_COEFF_EDGE = (0.5, 0.8)   # near-edge
SPEED_COEFF_FOG = (1.0, 1.2)    # far-edge
SPEED_COEFF_CLOUD = (1.4, 2.0)

# Machine Specifications
SPECS_EDGE_CPU = (2.0, 4.0)     # near-edge
SPECS_EDGE_COST = (3.0, 5.0)

SPECS_FOG_CPU = (2.0, 8.0)      # far-edge
...
# --- Weights ---
W1 = 0.35  # Cost  (change per scenario)
W2 = 0.2 # Security
W3 = 0.45   # Latency
