...
# --- Trust Configuration ---
# trust_level k = federation size k: clusters grouped in blocks of k+1 with mutual trust.
# 0  = isolated (self only)
# 2  = federations of 3 (e.g. {0,1,2}, {3,4,5}, …)
# 4  = federations of 5
# 6  = federations of 7
# 10 = full trust (all clusters trust all others)
TRUST_LEVELS = [0, 2, 4, 6, 10]

# Machines per Node
MACHINES_EDGE = (1, 2)
MACHINES_FOG = (2, 4)
MACHINES_CLOUD = (10, 10)
...
DEMAND_CPU_LIGHT = (0.05, 0.5)
DEMAND_CPU_HEAVY = (1.0, 3.0)

# 3. Security Requirements
MIN_SEC = 0
MAX_SEC = 3

# 4. Data Size (MB) — incoming inter-service payload range
DATA_SIZE = (0.1, 5.0)

# 5. mTLS
MTLS_PROBABILITY = 0.25
MTLS_CPU_OVERHEAD = (0.05, 0.4)   # CPU cores; linearly mapped from DATA_SIZE range
