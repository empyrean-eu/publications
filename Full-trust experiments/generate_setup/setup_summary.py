...
def save_plots(topo: Topology, apps: List[Application], cfg, out_dir: str,
    ...
    # --- Figure 1: Infrastructure overview (1x3) ---
    ...
    # Cluster breakdown (limited-trust) or machines by tier (full-trust)
    ax = axes[2]
    if include_clusters:
    ...
    # --- Figure 2: Workload overview (2x2) ---
    ...
    # --- Trust matrix (limited-trust only) ---
    p3 = None
