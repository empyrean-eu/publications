...
class Application:
    ...
    # CPU sidecar overhead per link (indexed by predecessor service); scaled from DATA_SIZE
    mtls_overheads: List[float] = field(default_factory=list)
...
class Topology:
    ...
    node_categories: np.ndarray  # 1: Edge, 2: Fog, 3: Cloud
